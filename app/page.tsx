        ...
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          ...
          <div>
            <p className="text-ink-soft leading-relaxed">
              PEMF helps you relax, unwind, and put your mind at rest. Fall
              asleep faster and enjoy better quality and quantity of sleep. Wake
              up less often during the night.
            </p>
            <p className="mt-4 text-ink-soft leading-relaxed">
              Deep sleep is crucial for physical and mental rejuvenation, and a
              foundation of holistic wellness.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2 items-center mb-12">
          ...
          <div>
            ...
            <p className="mt-3 text-ink-soft leading-relaxed">
              A holistic experience for the brain, also known as a Spa for the
              Mind. Brainwave Entrainment reduces stress, resulting in
              relaxation, calmness, and ease. It supports clear thinking, coping
              with stress, and achieving your goals.
            </p>
          </div>
        </div>
          ...
          <div className="rounded-2xl bg-white border border-brand/10 p-7 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <h3 className="font-display text-xl text-brand-dark">
                PEMF Helps Manage Stress
              </h3>
            </div>
            <p className="mt-4 text-base text-ink-soft leading-relaxed">
              Stress is a natural response to perceived or real challenges.
              Choose a holistic approach using PEMF as your healthy coping
              mechanism. It is safe, effective, non-invasive, and non-addictive.
              Use it anytime in the comfort of your own home or office.
            </p>
          </div>
          <div className="rounded-2xl bg-white border border-brand/10 p-7 shadow-sm">
            <div className="flex items-center gap-4">
              <Image
                ...
                width={72}
                height={72}
                className="rounded-lg object-cover h-[72px]"
              />
              <h3 className="font-display text-xl text-brand-dark">
                PEMF for Relaxation
              </h3>
            ...
            <p className="mt-4 text-base text-ink-soft leading-relaxed">
              Relaxation is the state of being calm, comfortable, and free from
              stress. PEMF can be effective for relaxation within minutes,
              aiding your body in returning to a calm and balanced state,
              improving sleep, mood, focus, and emotional well-being.
            </p>
          </div>
        </div>
      </Section>
      ...
      >
        <div className="grid gap-6 md:grid-cols-3">
          {sportsBenefits.map((b) => (
            <div
              key={b.title}
              className="rounded-2xl bg-white border border-brand/10 p-7 shadow-sm text-center"
            >
              <Image
                src={b.image}
                alt={b.title}
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-brand/10 bg-white p-7 shadow-sm">
            <h4 className="font-display text-xl text-brand-dark">
              Stress-Free Technique
            </h4>
            <p className="mt-2 text-base text-ink-soft leading-relaxed">
              Benefits of racehorses using hands-free Intelligent Magnetic
